# Source: https://github.com/DS3Lab/GraphFramEx/blob/main/code/explainer/pgmexplainer.py
...
class PGM_Node_Explainer:
    ...
    def explain(self, node_idx, target, num_samples=100, top_node=None, p_threshold=0.05, pred_threshold=0.1):
        ...
        node_attr = np.zeros(self.X.size(0))
        for node, p_value in pgm_stats.items():
