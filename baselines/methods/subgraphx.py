# Source: https://raw.githubusercontent.com/DS3Lab/GraphFramEx/main/code/explainer/subgraphx.py
# SubgraphX work: https://arxiv.org/pdf/2102.05152.pdf
import copy
import math
import os
...
from baselines.methods.subgraphx_base import (
    GnnNetsGC2valueFunc,
    GnnNetsNC2valueFunc,
    NC_mc_l_shapley,
    gnn_score,
...
class SubgraphX(object):
    ...
    def explain(
        ...
        node_mask = torch.zeros(self.ori_data.x.shape[0]).to(row.device)
